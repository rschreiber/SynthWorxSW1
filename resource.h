...
#define PLUG_MFR  "SynthWorxSW1"
#define PLUG_NAME "SynthWorx SW1"

// No quotes or spaces.
#define PLUG_CLASS_NAME SynthWorxSW1
...
// less than 16 chars.
#define BUNDLE_DOMAIN "nz.co.sysworx"
#define BUNDLE_NAME   "SynthWorxSW1"
	...
	// No spaces.
	#define PLUG_FACTORY    SynthWorxSW1_Factory
	#define PLUG_ENTRY      SynthWorxSW1_Entry
	#define PLUG_ENTRY_STR "SynthWorxSW1_Entry"
	#define VIEW_CLASS      SynthWorxSW1_View
	#define VIEW_CLASS_STR "SynthWorxSW1_View"

	// To-do: Create export file with two entries: PLUG_ENTRY and
	// PLUG_FACTORY, each with leading underscore (e.g. SynthWorxSW1.exp
	// with entries _SynthWorxSW1_Entry and _SynthWorxSW1_Factory).
...
#define VERSIONINFO_COPYRIGHT "2023 SynthWorx"
...
#define PLUG_UNIQUE_ID 'sw01'
#define PLUG_MFR_ID    'swrx'
